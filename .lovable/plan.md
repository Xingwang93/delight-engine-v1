...
## Intake form (Step 2)
Question: "Where and how do you prefer to train?"
...
- Picking a plan fills the price automatically (still editable for a one-off discount) and sets the lane: online plans get the Stripe link line, gym plans get the "pay in person" line.
...
**Prices above are my placeholders — please send the real ones and I'll swap them in.**
